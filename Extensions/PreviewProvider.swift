...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Place", value: "$12.5Bn", precentageChange: 25.34)
    let stat2 = StatisticModel(title: "Total Volume", value: "$1.23Tr")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "$50.4k", precentageChange: -12.34)
